...
const WcCarousel_Setting = {
    ...
    productWidth            :       '100%',             //  IF NEEDED - give the carousel inside boxes width  (px/presnteges...)                                            (String - as Default) 
    productHeight           :       '100%',             //  IF NEEDED - give the carousel inside boxes height (px/presnteges...)                                            (String - as Default) 
