...
const WcCarousel_Setting = {
    carosulId                      :      '00',                //  Give the carousel unique ID                                                                                     (String - '00' as Default) 
    ...
    carouselWidth           :       '100%',             //  Give the carousel a width (px/presnteges...) 
    carouselHeight          :       '200px',             //  Give the carousel a width (px/presnteges...)                                                                      (String - '100%' fullscreen as Default)   
    ...
    productHeight           :       '100px',             //  IF NEEDED - give the carousel inside boxes height (px/presnteges...)                                            (String - as Default) 
