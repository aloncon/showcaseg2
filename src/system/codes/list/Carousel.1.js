                                     ...
                                     <Slider ref={ c => this.slider = c }{...settings} > 
                                        {
                                             this.state.productsList.products.map((product, index) => (
                                                <div key={index}  style={{width:'95%'}}>
                                                    ...
                                                    <div className={!this.state.isVertical ? 'wcCarouselProductBrowse' :'wcCarouselProductBrowseVertical'} >
                                                        ...
                                                        { product.vendorProductName &&
                                                            <div data-rows="4" className="wcCarouselProductTitle"><a href=''>{product.vendorProductName}</a></div>           
                                                        }
