...
export default class Header extends Component {
    ...
    render() { 
        ...
        if(hasTitle !== "" && hasLogo !== null){
            content=( 
            <div className="wc-cus-header row wc-row-eq-height" style={headerStyles}>
                    <div className="col-xs-6 wc-header-title">
                        <h1 style={titleStyle}>{this.props.title}</h1>
                    </div>
                    <div className="col-xs-6 wc-header-logo">
                        <NavLink to="/">
                            <WcResource>
            ...
            <div className="wc-cus-header row" style={headerStyles}>
                <div className="col-xs-12 wc-header-title">
                    <h1 style={titleStyle}>{this.props.title}</h1>
                </div>
            </div>)}
            ...
            content = (
            <div className="wc-cus-header row" style={headerStyles}>
                <div className="col-xs-12 wc-header-logo">
                    <NavLink to="/">
                        <WcResource>
