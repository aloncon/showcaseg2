    ...
    constructor(){
        ...
        this.setConfig = (configObj) =>{
            return configObj ? {
                ...
                defaultOverlayPosition  : configObj.defaultOverlayPosition ? configObj.defaultOverlayPosition : "",
                maxButtonsAllowed       : configObj.maxButtonsAllowed ? configObj.maxButtonsAllowed : 50,
                menuOrientation         : configObj.menuOrientation ? configObj.menuOrientation : "left-to-right",
                menuSize                : configObj.menuSize ? configObj.menuSize : "small",
                overlayType             : configObj.overlayType ? configObj.overlayType : "tooltip",
                poweredByWebcollage     : configObj.poweredByWebcollage ? configObj.poweredByWebcollage : "none",
                scrollOverlayToView     : configObj.scrollOverlayToView ? configObj.scrollOverlayToView : false,
                sectionOrder            : configObj.sectionOrde ? configObj.sectionOrde : [],
